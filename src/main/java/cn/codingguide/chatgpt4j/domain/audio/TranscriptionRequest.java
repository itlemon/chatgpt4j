...
public class TranscriptionRequest {
    ...
    public static final class Builder {
        ...
        /**
         * 非必需参数：The format of the transcript output, in one of these options: json, text, srt, verbose_json, or vtt. json is default.
         */
        ...
        /**
         * 非必需参数：输入音频的语言。 以 ISO-639-1 格式提供输入语言将提高准确性和延迟。
         */
